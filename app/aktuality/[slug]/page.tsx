...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  try {
    article = (await getNewsBySlug(params.slug)) as NewsArticle | null
  } catch (e) {
    console.error("getNewsBySlug metadata error:", e)
    article = null
  }
  ...
  return {
    title: article.meta_title || `${article.title} – Aktuality – Webmajstr`,
...
export default async function NewsDetailPage({ params }: PageProps) {
  ...
  try {
    ...
    console.error("getNewsBySlug page error:", e)
    article = null
  }
