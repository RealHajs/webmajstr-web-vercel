    ...
    <section className="relative bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white py-20 lg:py-40">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-6xl mx-auto text-center">
          <h1 className="text-4xl lg:text-6xl font-bold mb-6 leading-tight">Váš digitální úspěch začíná zde</h1>
          <p className="text-xl lg:text-2xl mb-8 text-gray-300">
            Komplexní webové řešení, SEO s AI, reklama na rally autě a v e-sportu. 
          </p>
          <br /><br /><br /><br />
